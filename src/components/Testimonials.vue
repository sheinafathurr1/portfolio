...
<template>
  <section id="testimonials" class="py-24 px-4 relative z-10 transition-colors duration-300">
    <div class="max-w-3xl mx-auto">
      ...
      >
        <div class="glass-card p-8 md:p-10 rounded-2xl shadow-lg shadow-black/5 dark:shadow-black/20 relative overflow-hidden min-h-[260px] flex flex-col justify-center">
