...
<template>
  ...
  >
    ...
    <div class="relative z-10 max-w-6xl mx-auto w-full">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 xl:gap-20 items-center">
        ...
        <div class="text-center lg:text-left">
          ...
          <div data-aos="zoom-in" class="flex justify-center lg:justify-start mb-8">
            <div class="relative inline-block">
              <div
                class="absolute -inset-1.5 rounded-full bg-gradient-to-r from-blue-500 via-cyan-400 to-violet-500 opacity-80 blur-sm animate-spin"
                style="animation-duration:5s"
              ></div>
              <div
                class="relative w-24 h-24 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-3xl md:text-4xl font-black text-white shadow-2xl border-4 border-white dark:border-gray-900"
              >
                S
              </div>
              <div
          ...
          <div data-aos="fade-up" data-aos-delay="100">
            ...
            <h1 class="text-5xl md:text-6xl xl:text-7xl font-extrabold mb-4 text-gray-900 dark:text-white tracking-tight leading-none">
              <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-violet-500">Switch</span>
            </h1>
          </div>
          ...
          >
            ...
            <span class="inline-block w-0.5 h-5 bg-blue-500 animate-pulse"></span>
          </h2>
        ...
        <div data-aos="fade-left" data-aos-delay="200" class="hidden lg:flex justify-center">
          <div class="relative animate-float w-full max-w-[460px]">
            <!-- Glow -->
            <div class="absolute -inset-4 bg-gradient-to-r from-blue-600/20 via-cyan-500/10 to-violet-600/20 rounded-3xl blur-2xl opacity-75"></div>
    ...
    <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-400 dark:text-gray-600">
      ...
      <div class="w-px h-8 bg-gradient-to-b from-gray-400 dark:from-gray-600 to-transparent animate-pulse"></div>
    </div>
  </section>
</template>
