    ...
    <div class="relative max-w-4xl mx-auto">
      ...
      <div data-aos="zoom-in" data-aos-delay="150">
        ...
        >
          ...
          <div
            v-if="isSuccess"
            class="mt-4 p-4 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 rounded-xl text-center text-sm font-medium border border-green-200 dark:border-green-800/50 flex items-center justify-center gap-2"
          >
